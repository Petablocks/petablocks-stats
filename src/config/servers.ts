...
export const GAME_SERVERS: GameServerConfig[] = [
  {
    ...
    port: parseInt(process.env.SERVER_FABRIC_PORT || '25565', 10),
    type: 'fabric',
    version: '1.20.1',
    hasPlan: true,
    hasLuckPerms: true,
  ...
  },
  {
    ...
    port: parseInt(process.env.SERVER_CREATE2_PORT || '25565', 10),
    type: 'neoforge',
    version: '1.21.1',
    hasPlan: false,
    hasLuckPerms: false,
  ...
  },
  {
    ...
    port: parseInt(process.env.SERVER_PATREON_PORT || '25565', 10),
    type: 'neoforge',
    version: '1.21.1',
    hasPlan: false,
    hasLuckPerms: false,
